...
#define PC_CPU_MODEL_IDS(v) \
    { "qemu32-" TYPE_X86_CPU, "model-id", "INTE Virtual CPU version " v, },\
    { "qemu64-" TYPE_X86_CPU, "model-id", "INTE Virtual CPU version " v, },\
    { "athlon-" TYPE_X86_CPU, "model-id", "INTE Virtual CPU version " v, },
